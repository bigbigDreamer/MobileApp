<template>
  <div>
    <b-row>
      <b-col>
        <div>
          <b-img :src="require('../assets/img/boot.jpg')" fluid alt="Responsive image"/>
        </div>
      </b-col>
    </b-row>
    <b-row>
    ...
    <b-row>
      <b-col>
        ...
        <b-card class="text-center">
          ...
          <br>
          <a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=62010302000249"
